   ...
   <body>
	...
	if($result = mysqli_query($connection, $sql))
	{
		...
		if (mysqli_num_rows($result) > 0) 
		{
			...
			//if the account has enough money to withdraw the desired amount
			if ($row[0]>= $withdraw)
			{
				//take out the amount they want to withdraw
				$balance= $row[0]-$withdraw;
				...
				{
					echo "<h2>Amount Withdrawn Successfully.</h2>";
					echo "<h2>A cheque with the amount withdrawn should arrive in 2-3 Business Days.</h2>";
			...
			{
				echo "<h2> Error While Withdrawing: Not enough Money on the account to complete Withdrawal</h2><br>";
			}
		}
